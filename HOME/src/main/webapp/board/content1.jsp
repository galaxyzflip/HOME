...
<table width="500" border="1" cellspacing="0" cellpadding="0" bgcolor="<%=bodyback_c %>" align="center">
	...
	<tr align="center">
		<td align=center>
			작성자<br><input type="text" name=commenter size=10><br>
			비밀번호<br><input type="password" name=passwd size=10>
...
<center>
	...
	<% 
		if(count>0){
			...
			if(startPage > 5){%>
				 <a href="content1.jsp?num=<%=num %>&pageNum=<%=pageNum %>?pageNum=<%=startPage - 5 %>">[이전]</a>
			<%}
